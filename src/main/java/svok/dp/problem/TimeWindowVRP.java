/*
 * Copyright 2023 Katerina Svobodova
  ...
  static void printSolution(
    ...
    for (int i = 0; i < data.vehicleNumber; ++i) {
      ...
      while (!routing.isEnd(index)) {
        ...
        route += manager.indexToNode(index) + " " + Message.time + "(" + solution.min(timeVar) + ","
      ...
      Presenter.println(Message.timeOfRoute + solution.min(timeVar) + "min");
      totalTime += solution.min(timeVar);
    }
    Presenter.println(Message.totalTimeOfRoutes + totalTime + "min");
  }
